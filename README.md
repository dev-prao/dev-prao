...
<!-- 🔹 Study log & solved.ac 가로 정렬 (테두리 제거 버전) -->
...
<!-- 🔹 티스토리 포스트 박스 (테두리+배경) -->
<div style="border: 3px solid #FFA500; border-radius: 12px; padding: 20px; width: 85%; max-width: 720px; margin: 20px auto; background: #fffdf5; box-shadow: 0 3px 8px rgba(0,0,0,0.1);">
